...
public class Declaration implements Comparable {
    ...
    public static final int TYPE_NONE = 0, TYPE_CONSECUTIVE = 1, TYPE_SQUARE = 2;
    ...
    public static void filterStrongest(List<Declaration> dec1, List<Declaration> dec2) {
        ...
        List<Declaration>
                ...
                consDec2 = dec2.stream().filter(Declaration::isFromConsecutive).collect(Collectors.toList());
    ...
    public boolean isFromConsecutive() {
        return this.type == TYPE_CONSECUTIVE;
    }
